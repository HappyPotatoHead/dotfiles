...
hl.curve("ease", { type = "bezier", points = { { 0.25, 0.10 }, { 0.25, 1.00 } } })

hl.animation({ leaf = "global", enabled = true, speed = 10.00, bezier = "default" })
hl.animation({ leaf = "border", enabled = true, speed = 5.39, bezier = "easeOutQuint" })

hl.animation({ leaf = "windows", enabled = true, speed = 5.00, bezier = "overshot", style = "gnomed" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3.00, bezier = "overshot", style = "slide top" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3.00, bezier = "overshot", style = "gnomed" })

hl.animation({ leaf = "fadeIn", enabled = true, speed = 1.73, bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 1.46, bezier = "almostLinear" })
hl.animation({ leaf = "fade", enabled = true, speed = 3.03, bezier = "quick" })
hl.animation({ leaf = "layers", enabled = true, speed = 3.81, bezier = "easeOutQuint" })
hl.animation({ leaf = "layersIn", enabled = true, speed = 8.00, bezier = "easeOutQuint", style = "fade" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 1.50, bezier = "linear", style = "fade" })
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 1.79, bezier = "almostLinear" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1.39, bezier = "almostLinear" })

hl.animation({ leaf = "workspaces", enabled = true, speed = 2.00, bezier = "overshot", style = "slide" })
